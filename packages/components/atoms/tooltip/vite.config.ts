...
const copyPackageJson = () => {
  ...
  const dest = path.resolve(__dirname, '../../../../dist/components/tooltip/package.json'); // Resolve destination path
...
export default defineConfig({
  ...
  build: {
    outDir: path.resolve(__dirname, '../../../../dist/components/tooltip/dist'),
    lib: {
      entry: path.resolve(__dirname, 'src/index.ts'),
      name: "@sora-ui-material/tooltip",
      formats: ['es', 'umd'],
