...
const copyPackageJson = () => {
  ...
  const dest = path.resolve(__dirname, '../../../../dist/components/badge/package.json'); // Resolve destination path
...
export default defineConfig({
  ...
  build: {
    outDir: path.resolve(__dirname, '../../../../dist/components/badge/dist'),
    lib: {
      entry: path.resolve(__dirname, 'src/index.ts'),
      name: "@sora-ui-material/badge",
      formats: ['es', 'umd'],
