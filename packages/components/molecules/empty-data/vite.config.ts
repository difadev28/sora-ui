...
const copyPackageJson = () => {
  ...
  const dest = path.resolve(__dirname, '../../../../dist/components/empty-data/package.json'); // Resolve destination path
...
export default defineConfig({
  ...
  build: {
    outDir: path.resolve(__dirname, '../../../../dist/components/empty-data/dist'),
    lib: {
