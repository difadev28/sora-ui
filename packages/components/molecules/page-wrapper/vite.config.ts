...
const copyPackageJson = () => {
  ...
  const dest = path.resolve(__dirname, '../../../../dist/components/page-wrapper/package.json'); // Resolve destination path
...
export default defineConfig({
  ...
  build: {
    outDir: path.resolve(__dirname, '../../../../dist/components/page-wrapper/dist'),
    lib: {
